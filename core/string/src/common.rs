...
impl StaticJsStrings {
    ...
    well_known_statics! {
        ...
        (ATOMICS, "Atomics"),
        (ITERATOR, "Iterator"),
        (ITERATOR_HELPER, "Iterator Helper"),
        (GET_ITERATOR_PROTOTYPE_TO_STRING_TAG, "get Iterator.prototype [Symbol.toStringTag]"),
        (SET_ITERATOR_PROTOTYPE_TO_STRING_TAG, "set Iterator.prototype [Symbol.toStringTag]"),
        (BIG_INT, "BigInt"),
        (BOOLEAN, "Boolean"),
        (DATA_VIEW, "DataView"),
        (DATE, "Date"),
...
const RAW_STATICS: &[StaticString] = &[
    ...
    StaticString::new(JsStr::latin1("Iterator Helper".as_bytes())),
    StaticString::new(JsStr::latin1("get Iterator.prototype [Symbol.toStringTag]".as_bytes())),
    StaticString::new(JsStr::latin1("set Iterator.prototype [Symbol.toStringTag]".as_bytes())),
