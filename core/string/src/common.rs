...
const RAW_STATICS: &[StaticString] = &[
    ...
    StaticString::new(JsStr::latin1("SuppressedError".as_bytes())),
    StaticString::new(JsStr::latin1("DisposableStack".as_bytes())),
    StaticString::new(JsStr::latin1("AsyncDisposableStack".as_bytes())),
