...
//! # TC55 Status
//!
//! `TextEncoder`, `TextDecoder`, `TextEncoderStream`, and `TextDecoderStream` are required in the
//! `WinterTC` TC55 Minimum Common Web API. `TextEncoder` and `TextDecoder` are implemented here.
//!
//! # TODO
//!
