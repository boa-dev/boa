...
///
/// This is the entry point used by [`crate::register`] to install `console` as part of the
/// full TC55 API surface. To register `console` with a custom [`Logger`] instead, call
/// [`Console::register_with_logger`] directly.
///
/// # Errors
///
/// Returns a [`boa_engine::JsError`] if the `console` property cannot be defined on the global
/// object.
#[allow(clippy::needless_pass_by_value)]
pub fn register(_realm: Option<boa_engine::realm::Realm>, context: &mut Context) -> JsResult<()> {
