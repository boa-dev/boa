...
impl TypedArray {
    ...
    /// Validates a `usize` index to be in bounds for the inner buffer of this `TypedArray`.
    ///
    ...
    pub(crate) fn validate_index_usize(&self, index: usize, buf_len: usize) -> Option<usize> {
