...
/// Objects in JavaScript may be defined as an unordered collection of related
...
/// an [`Object`][object]. Objects consist of properties, which are used to
/// describe an object. Values of object properties can either contain
/// [`primitive`][primitive] data types or other objects.
///
/// More information:
