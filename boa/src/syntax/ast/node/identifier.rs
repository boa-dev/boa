...
///
/// An identifier differs from a string in that a string is data, while an
/// identifier is part of the code. In JavaScript, there is no way to convert
/// identifiers to strings, but sometimes it is possible to parse strings into
/// identifiers.
///
/// More information:
