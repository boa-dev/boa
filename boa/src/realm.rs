...
//!
//! A realm is represented in this implementation as a Realm struct with the
//! fields specified from the spec.
...
impl Realm {
    pub fn create() -> Self {
        ...
        // We need to clone the global here because its referenced from separate places
        // (only pointer is cloned)
...
// Similar to new_global_environment in lexical_environment, except we need to
// return a GlobalEnvirionment
