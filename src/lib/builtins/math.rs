...
pub fn create_constructor(global: &Value) -> Value {
    ...
    make_builtin_fn!(abs, named "abs", of math);
    make_builtin_fn!(acos, named "acos", of math);
    make_builtin_fn!(asin, named "asin", of math);
    make_builtin_fn!(atan, named "atan", of math);
    make_builtin_fn!(atan2, named "atan2", of math);
    make_builtin_fn!(cbrt, named "cbrt", of math);
    make_builtin_fn!(ceil, named "ceil", of math);
    make_builtin_fn!(cos,  named "cos", of math);
    make_builtin_fn!(exp, named "exp", of math);
    make_builtin_fn!(floor, named "floor", of math);
    make_builtin_fn!(log, named "log", of math);
    make_builtin_fn!(max, named "max", of math);
    make_builtin_fn!(min, named "min", of math);
    make_builtin_fn!(pow, named "pow", of math);
    make_builtin_fn!(_random, named "random", of math);
    make_builtin_fn!(round, named "round" , of math);
    make_builtin_fn!(sin, named "sin", of math);
    make_builtin_fn!(sqrt, named "sqrt", of math);
    make_builtin_fn!(tan, named "tan", of math);
    math
}
