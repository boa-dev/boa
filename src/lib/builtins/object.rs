...
pub fn create_constructor(_: &Value) -> Value {
    ...
    make_builtin_fn!(set_proto_of, named "setPrototypeOf", of object);
    make_builtin_fn!(get_proto_of, named "getPrototypeOf", of object);
    make_builtin_fn!(define_prop, named "defineProperty", of object);
    object
}
