...
pub fn create_constructor(global: &Value) -> Value {
    ...
    make_fn!(char_at, named "charAt", of proto);
    make_fn!(char_code_at, named "charCodeAt", of proto);
    make_fn!(to_string, named "toString", of proto);
    make_fn!(concat, named "concat", of proto);
    make_fn!(repeat, named "repeat", of proto);
    make_fn!(slice, named "slice", of proto);
    make_fn!(starts_with, named "startsWith", of proto);
    make_fn!(ends_with, named "endsWith", of proto);
    make_fn!(includes, named "includes", of proto);
    make_fn!(index_of, named "indexOf", of proto);
    make_fn!(last_index_of, named "lastIndexOf", of proto);
    make_fn!(r#match, named "match", of proto);
    make_fn!(pad_end, named "padEnd", of proto);
    make_fn!(pad_start, named "padStart", of proto);
    make_fn!(trim, named "trim", of proto);
    make_fn!(trim_start, named "trimStart", of proto);
    make_fn!(to_lowercase, named "toLowerCase", of proto);
    make_fn!(to_uppercase, named "toUpperCase", of proto);
    make_fn!(substring, named "substring", of proto);
    make_fn!(substr, named "substr", of proto);
    make_fn!(value_of, named "valueOf", of proto);
    make_fn!(match_all, named "matchAll", of proto);
