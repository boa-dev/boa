...
pub fn create_constructor(global: &Value) -> Value {
    ...
    make_builtin_fn!(char_at, named "charAt", of proto);
    make_builtin_fn!(char_code_at, named "charCodeAt", of proto);
    make_builtin_fn!(to_string, named "toString", of proto);
    make_builtin_fn!(concat, named "concat", of proto);
    make_builtin_fn!(repeat, named "repeat", of proto);
    make_builtin_fn!(slice, named "slice", of proto);
    make_builtin_fn!(starts_with, named "startsWith", of proto);
    make_builtin_fn!(ends_with, named "endsWith", of proto);
    make_builtin_fn!(includes, named "includes", of proto);
    make_builtin_fn!(index_of, named "indexOf", of proto);
    make_builtin_fn!(last_index_of, named "lastIndexOf", of proto);
    make_builtin_fn!(r#match, named "match", of proto);
    make_builtin_fn!(pad_end, named "padEnd", of proto);
    make_builtin_fn!(pad_start, named "padStart", of proto);
    ...
    make_builtin_fn!(substring, named "substring", of proto);
    make_builtin_fn!(substr, named "substr", of proto);
    make_builtin_fn!(value_of, named "valueOf", of proto);
    make_builtin_fn!(match_all, named "matchAll", of proto);
