...
impl BuiltInConstructor for Collator {
    ...
    fn constructor(
        ...
        let usage = get_option(&options, "usage", context)?.unwrap_or_default();
        ...
        let collation = get_option(&options, "collation", context)?;
        ...
        let case_first = get_option(&options, "caseFirst", context)?;
        ...
        let sensitivity = get_option(&options, "sensitivity", context)?
        ...
        let ignore_punctuation: bool =
            get_option(&options, "ignorePunctuation", context)?.unwrap_or_default();
