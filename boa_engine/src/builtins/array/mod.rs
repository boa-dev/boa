...
impl Array {
    ...
    pub(crate) fn unscopables_object() -> JsObject {
            ...
            .configurable(true);
        {
            ...
            obj.insert("findLast", true_prop.clone());
            // 9. Perform ! CreateDataPropertyOrThrow(unscopableList, "findLastIndex", true).
            obj.insert("findLastIndex", true_prop.clone());
