...
impl JsDate {
    ...
    // #[inline]
    // pub fn get_date(&self, context: &mut Context) -> JsValue {
    //     Date::get_date(&self.inner.clone()).into()
    // }
    ...
    // #[inline]
    // pub fn get_day(&self, context: &mut Context) -> JsValue {
    //     Date::get_day(&self.inner.clone().into()).into()
    // }
    ...
    // #[inline]
    // pub fn get_full_year(&self, context: &mut Context) -> JsValue {
    //     Date::get_full_year(&self.inner.clone().into()).into()
    // }
    ...
    // #[inline]
    // pub fn get_hours(&self, context: &mut Context) -> JsValue {
    // Date::get_hours(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_milliseconds(&self, context: &mut Context) -> JsValue {
    // Date::get_milliseconds(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_minutes(&self, context: &mut Context) -> JsValue {
    // Date::get_minutes(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_month(&self, context: &mut Context) -> JsValue {
    // Date::get_month(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_seconds(&self, context: &mut Context) -> JsValue {
    // Date::get_seconds(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_time(&self, context: &mut Context) -> JsValue {
    // Date::get_time(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_timezone_offset(&self, context: &mut Context) -> JsValue {
    // Date::get_timezone_offset(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_date(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_date(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_day(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_day(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_full_year(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_full_year(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_hours(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_hours(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_milliseconds(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_milliseconds(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_minutes(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_minutes(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_month(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_month(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_utc_seconds(&self, context: &mut Context) -> JsValue {
    // Date::get_utc_seconds(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn get_year(&self, context: &mut Context) -> JsValue {
    // Date::get_year(self.inner.clone().into, context)
    // }
    ...
    // #[inline]
    // pub fn to_gmt_string(&self, context: &mut Context) -> JsValue {
    //     Date::to_gmt_string(&self.inner.clone().into(), &[JsValue::Null], context).into()
    // }
    ...
    // #[inline]
    // pub fn to_local_date_string(&self, values: &[JsValue], context: &mut Context) -> JsValue {}

    // /// Returns a string representing the given date according to language-specific conventions.
    // ///
    // /// Same as JavaScript's `Date.prototype.toLocaleDateString()`.
    // #[inline]
    // pub fn to_local_string(&self, values: &[JsValue], context: &mut Context) -> JsValue {}
    ...
    // #[inline]
    // pub fn value_of(&self, context: &mut Context) -> JsValue {
    //     Date::value_of(self.inner.clone().into(), context)
    // }
}
