...
pub struct Promise {
    ...
    promise_fulfill_reactions: (), //  to a new empty List.
    promise_reject_reactions: (), //  to a new empty List.
    promise_is_handled: bool, //  to false.
}

struct ResolvingFunction {
...
impl Promise {
    ...
    fn constructor(
        ...
        let promise = get_prototype_from_constructor(
            new_target,
            StandardObjects::promise_object,
            context,
        )?;
        ...
        let resolving_functions = Self::create_resolving_functions(obj);
        
        // // 9. Let completion be Completion(Call(executor, undefined, « resolvingFunctions.[[Resolve]], resolvingFunctions.[[Reject]] »)).
        // let completion = completion(
        //     call(executor, undefined, resolving_functions.resolve, resolvind_functions.reject)
        // );

        // // 10. If completion is an abrupt completion, then
        // if completion.is_abrupt() {
        //     // a. Perform ? Call(resolvingFunctions.[[Reject]], undefined, « completion.[[Value]] »).
        //     call(resolving_functions.reject, undefined, completion.value)
        // }
    ...
    fn create_resolving_functions(promise: JsObject) {
